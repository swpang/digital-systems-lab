...
#
# Generated by export_simulation on Thu Oct 27 00:11:54 +0900 2022
#
################################################################################
...
'-reset_run' switch to the './bram_32x16.sh' script.

./bram_32x16.sh -reset_run
...
./bram_32x16.sh -noclean_files

For more information on the script, please type './bram_32x16.sh -help'.
